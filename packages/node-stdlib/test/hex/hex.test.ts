...
describe("hex/hex.ts", () => {
  test.each(tests)("encode(): %s", (enc, dec) => {
  ...
  test.each(tests)("encodeToString(): %s", (enc, dec) => {
    const src = new Uint8Array(dec);
